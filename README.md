...
# MiniDev-Logistic:  ms-route

La presente iniciativa contiene el codigo de un mini desarrollo de software BackEnd.
En particular, este proyecto contiene el modulo denominado ms-route.
...
In particular, this project contains the module called ms-route.
